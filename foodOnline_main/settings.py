...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processor.get_vendor',  #APPNAME.FILE_NAME.FUNCTION_NAME
...
#FOR CONFIGURING STATIC FILES

STATIC_ROOT = BASE_DIR /'static'
STATICFILES_DIRS = [
    'foodOnline_main/static' # PATH OF THE STATIC FOLDER. MAKE SURE TO LOAD THE STATIC FILES.
]
...
EMAIL_USE_TLS = True #EMAIL WILL BE SEND SECURELY.
#we are using it in the utils.py file.
